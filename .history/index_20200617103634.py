...
def carve_point(m_rio_correto, m_refer):  # metodo para escavar os pontos de conexão
    ...
    for i in range(len(m_refer)):
        ...
        for k in range(8):
            print("Coor do Vizinho: ", x+dx[k], y+dy[k])
            print("Valor do ponto:", m_rio_correto[x+dx[k], y+dy[k]])
...
print(carve_point(matriz_rio_correto, matriz_elevacao_coodenadas).reshape(4, 2))
